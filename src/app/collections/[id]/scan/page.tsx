  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-slate-900">Schnell-Erfassung</h1>
      ...
      {!currentBarcode ? (
        <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200 text-center mb-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 mb-6">
          <div className="flex items-center gap-3 mb-4 p-3 bg-green-50 rounded-lg">
            ...
            <div>
              <p className="font-semibold text-green-700">Barcode erkannt</p>
              <p className="font-mono text-sm text-green-600">{currentBarcode}</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
          ...
          <div className="space-y-2">
            {scannedItems.map((item, i) => (
              ...
              >
                <div>
                  <p className={`font-medium ${item.saved ? 'text-green-700' : 'text-slate-400'}`}>
                    {item.name}
                  </p>
