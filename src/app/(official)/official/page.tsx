          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 sm:mb-8 sm:mb-10 md:mb-12 md:mb-16">
            {quickActions.map((action) => (
              <button
                ...
                className="group p-4 sm:p-6 rounded-xl bg-slate-800 hover:bg-slate-800 border border-slate-700 hover:border-amber-500/50 transition-all duration-200 text-left"
              >
