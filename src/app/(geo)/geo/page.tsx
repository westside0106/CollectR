          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-8 sm:mb-12 md:mb-16">
            {quickActions.map((action) => (
              <button
                ...
                className="group p-4 sm:p-6 rounded-xl bg-slate-800 hover:bg-slate-800 border border-slate-700 hover:border-emerald-500/50 transition-all duration-200 text-left"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {categories.map((category) => (
                <div
                  ...
                  `}
                  style={{
                    background: `linear-gradient(135deg, ${selectedCategory === category.id ? 'rgba(255,255,255,0.1)' : 'rgba(30,41,59,1)'} 0%, rgba(15,23,42,1) 100%)`
                  }}
                >
