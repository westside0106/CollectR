        ...
        <div className="relative max-w-7xl mx-auto container-responsive py-8 sm:py-12 md:py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-8 sm:mb-12 md:mb-16">
            {quickActions.map((action) => (
              <button
                ...
                className="group p-4 sm:p-6 rounded-xl bg-slate-800 hover:bg-slate-800 border border-slate-700 hover:border-red-500/50 transition-all duration-200 text-left"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
              {games.map((game) => (
                <div
                  ...
                  `}
                  style={{
                    background: `linear-gradient(135deg, ${selectedGame === game.id ? 'rgba(255,255,255,0.1)' : 'rgba(30,41,59,1)'} 0%, rgba(15,23,42,1) 100%)`
                  }}
                >
                  <div className={`absolute inset-0 bg-gradient-to-br ${game.color} opacity-10 rounded-xl sm:rounded-2xl`}></div>

                  <div className="relative z-10">
                    <div className="text-4xl sm:text-5xl md:text-6xl mb-3 sm:mb-4 text-center">{game.emoji}</div>
          ...
          <div className="bg-slate-800 backdrop-blur-lg rounded-xl sm:rounded-2xl card-padding border border-slate-700">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-xs sm:text-sm text-slate-400">Decks</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-purple-400 mb-1">
                  {loading ? '...' : stats.hotCards}
                </div>
                <div className="text-xs sm:text-sm text-slate-400">Hot Cards</div>
              </div>
            </div>
          ...
          <div className="mt-8 sm:mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 text-center">
            <div>
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">Deck Building</h3>
