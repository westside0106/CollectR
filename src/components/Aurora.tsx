  ...
  return (
    <div className={`absolute inset-0 overflow-hidden ${className}`}>
      ...
      >
        ...
        <ellipse cx="200" cy="200" rx="400" ry="300" fill="url(#aurora-gradient-1)" opacity={blend}>
        ...
        <ellipse cx="800" cy="800" rx="500" ry="400" fill="url(#aurora-gradient-2)" opacity={blend}>
        ...
        <ellipse cx="500" cy="500" rx="350" ry="350" fill="url(#aurora-gradient-1)" opacity={blend * 0.6}>
