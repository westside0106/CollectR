...
export function SphereNavigation() {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <nav className="hidden lg:flex items-center gap-1 bg-slate-800/50 rounded-full px-2 py-1.5">
        {spheres.map((sphere) => {
      ...
      <button
        ...
        className="lg:hidden p-2 rounded-lg bg-slate-800/50 text-slate-300 hover:text-white"
      >
      ...
      {/* Mobile Menu */}
      {showMobileMenu && (
        <div className="lg:hidden absolute top-16 left-0 right-0 bg-slate-900/95 backdrop-blur-lg border-b border-slate-700 shadow-xl z-50">
